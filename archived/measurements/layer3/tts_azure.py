"""Azure TTS Messung — HTTPS Streaming (Italy North, Neural Voice).
...
_HOST = "italynorth.tts.speech.microsoft.com"
_URL = "https://italynorth.tts.speech.microsoft.com/cognitiveservices/v1"
_TEXT = "Good morning! How can I assist you today?"
_SSML = (
    "<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xml:lang='en-US'>"
    f"<voice name='en-US-JennyNeural'>{_TEXT}</voice>"
    "</speak>"
)
